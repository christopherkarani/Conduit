...
private func requirePartialToolCall(_ partial: PartialToolCall?) -> PartialToolCall {
    guard let partial else {
        Issue.record("Expected valid PartialToolCall")
...
struct PartialToolCallTests {
    ...
    struct ValidInitializationTests {
        ...
        func createsWithValidParameters() {
            let partial = requirePartialToolCall(PartialToolCall(
                id: "call_123",
    ...
    @Suite("Invalid Initialization")
    struct InvalidInitializationTests {

        @Test("Returns nil for empty id")
        func emptyIdReturnsNil() {
        ...
        @Test("Returns nil for empty tool name")
        func emptyToolNameReturnsNil() {
            let partial = PartialToolCall(
                id: "call_123",
                toolName: "",
                index: 0,
        ...
        @Test("Returns nil for index below 0")
        ...
        @Test("Returns nil for index above maximum")
        func tooLargeIndexReturnsNil() {
            let partial = PartialToolCall(
                id: "call_123",
                toolName: "tool",
    ...
    struct IndexBoundaryTests {
        ...
        // Note: Invalid indices return nil from PartialToolCall.init.
    }
    ...
    struct PreconditionDocumentationTests {
        ...
        // Note: Invalid values return nil from PartialToolCall.init.
    ...
    struct EquatableConformanceTests {
        ...
        func equalPartialToolCallsAreEqual() {
            let partial1 = requirePartialToolCall(PartialToolCall(
                id: "call_123",
                toolName: "get_weather",
                index: 0,
                argumentsFragment: #"{"city": "SF"}"#
            ...
            let partial2 = requirePartialToolCall(PartialToolCall(
                id: "call_123",
                toolName: "get_weather",
                index: 0,
                argumentsFragment: #"{"city": "SF"}"#
    ...
    struct HashableConformanceTests {
        ...
        func canBeStoredInSet() {
            ...
            let partial3 = requirePartialToolCall(PartialToolCall(
                id: "call_1",
                toolName: "tool_a",
                index: 0,
                argumentsFragment: "{}"
