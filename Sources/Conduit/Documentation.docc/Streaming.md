...
When using `@Generable` types with streaming, incomplete JSON is progressively recovered into a `PartiallyGenerated` instance. See <doc:StructuredOutput> for details.
