...
- <doc:Architecture> — Understand the protocol hierarchy and design patterns
- <doc:Streaming> — Real-time token streaming
- <doc:StructuredOutput> — Type-safe LLM responses with `@Generable`
- <doc:ProvidersOverview> — Choose the right provider for your use case
